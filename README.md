...
You can access the Wordpress service from Kali on:
  - http://`minikube_ip`:30100 (e.g. `http://192.168.99.100:30100`)
  - https://`minikube_ip`:30101 (e.g. `https://192.168.99.100:30101`)
...
Splunk is exposed at:
  ...
  - http://`minikube_ip`:30700 (e.g. `http://192.168.99.100:30700`)
